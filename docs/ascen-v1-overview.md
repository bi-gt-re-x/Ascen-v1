...
- `frontend/html/` — the original server-rendered pages (homepage, dashboard, calendar, growth, goals, and the footer pages, flattened out of `Misc HTML/`). Still served, while `frontend/src/` takes them over page by page.
