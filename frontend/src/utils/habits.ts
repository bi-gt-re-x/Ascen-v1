...
// --------------------------------------------------------------------------
/**
 * What the tab shows when the account cannot fill it yet.
 *
 * Kept in one block, exported under one name, and never mixed with a real
 * figure: a panel drawing these carries the Sample chip in its top right, and
 * every caller decides between the two at the top of its render rather than
 * per field. Delete this block and the `sample` props when accounts routinely
 * carry enough history to fill the tab.
 *
 * The shapes are deliberately unremarkable — a plausible account rather than an
 * impressive one, so nobody mistakes the demo for a target.
 */
export const SAMPLE_HABITS: Habit[] = [
  {
    ...
    firstSeen: null,
    strength: 'strong',
    weekly: [3, 4, 5, 4, 5, 5, 4, 6, 5, 5, 4, 5],
    phases: [3.3, 4.6, 5.0, 4.8],
    total: 55,
    xp: 4400,
  },
  {
    ...
    firstSeen: null,
    strength: 'strong',
    weekly: [1, 2, 3, 3, 4, 4, 3, 5, 4, 5, 4, 5],
    phases: [2.0, 3.5, 4.0, 4.6],
    total: 46,
    xp: 5200,
  },
  {
    ...
    firstSeen: null,
    strength: 'developing',
    weekly: [4, 3, 4, 3, 2, 3, 3, 2, 3, 3, 2, 3],
    phases: [3.6, 2.8, 2.8, 2.6],
    total: 37,
    xp: 2100,
  },
  {
    ...
    firstSeen: null,
    strength: 'developing',
    weekly: [2, 2, 1, 2, 1, 1, 2, 1, 1, 2, 1, 1],
    phases: [1.8, 1.4, 1.4, 1.1],
    total: 17,
    xp: 1300,
  },
  {
    ...
    firstSeen: null,
    strength: 'declining',
    weekly: [2, 2, 1, 1, 1, 0, 1, 1, 0, 0, 1, 0],
    phases: [1.6, 0.8, 0.6, 0.3],
    total: 10,
    xp: 600,
  },
  {
    ...
    firstSeen: null,
    strength: 'developing',
    weekly: [1, 1, 2, 1, 2, 2, 2, 2, 3, 2, 2, 2],
    phases: [1.3, 1.8, 2.3, 2.0],
    total: 22,
    xp: 900,
  },
];
...
export const SAMPLE_PATTERNS: HabitPattern[] = [
  {
    id: 'sample-evening',
    text: 'Math Practice happens in the evening',
    support: '31 of 42 sessions — 74%',
    frequency: 'Frequently',
    tone: 'blue',
  },
  {
    id: 'sample-after',
    text: 'Coding and Math Practice happen on the same day',
    support: '19 days of 46',
    frequency: 'Frequently',
    tone: 'pink',
  },
  {
