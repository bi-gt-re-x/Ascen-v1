...
TASKS_JSON = os.path.join(DATA_DIR, 'task.json')
...
def inject_theme():
    """Expose the signed-in account's theme to every template as `current_theme`,
    so pages can render <html data-theme="..."> server-side with no flash."""
...
def get_growth_ratings():
    ...
    # --- Overall = simple average of the four metric scores ---
    parts = {
